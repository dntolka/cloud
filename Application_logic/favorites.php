...
<head>
    ...
    <script>
            $(document).ready(function(){
                ...
                $("button[id^='del_']").on('click', function(){
                    /* Get input value on change */
                    var con_id = $(this).closest('tr').find('td:eq(0)').text();
                    var uid = $(this).closest('tr').find('td:eq(5)').text();

                    $(this).closest('tr').remove();
                    $.ajax({
                        url:"delFavorite.php",    //the page containing php script
                        type: "post",    //request type,
                        dataType: "json",
                        data: {id:con_id, uid:uid},
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h2 class="pull-left">Favorites Details</h2>
                    </div>
                    <?php
